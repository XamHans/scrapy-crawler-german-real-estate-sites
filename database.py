...
class DataBase:
    ...
    mongo_immos = None
    myclient = pymongo.MongoClient("mongodb://hans:DopeDaysGone1807!@161.97.79.7:30001/immo_db?authSource=admin")
    ...
    def findAlleStadte(self):
        foundStadte = self.mydb['stadte'].find()
        return foundStadte
